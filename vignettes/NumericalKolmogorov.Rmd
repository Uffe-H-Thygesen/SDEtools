...
We consider the numerical analysis of the forward and backward Kolmogorov equation, using the *fvade* function (Finite Volume method for Advection-Diffusion Equations).
