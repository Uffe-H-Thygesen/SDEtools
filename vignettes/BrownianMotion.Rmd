...
---
Brownian motion is the fundamental building block in the theory of stochastic differential equations. This vignette explores some basics of Brownian motion: How to simulate sample paths, the statistics of Brownian motion and how to verify them from simulations, the Brownian bridge, and the properties of the maximum and hitting times.
